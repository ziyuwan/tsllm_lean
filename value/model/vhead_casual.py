...
from value.model.base import PreTrainedModelWrapper
...
class ValueHeadedLLM(PreTrainedModelWrapper):
    ...
    def __init__(
        self, base_model: AutoModel, loss_fn: callable = nn.MSELoss(), **kwargs
    ):
        ...
        # FIXME(ziyu): should we constrain here, the cat_head's weight
        #  must be float32 or we can also cast it to bfloat16?
    ...
    def forward(
        ...
        """input_ids: BxL, torch.long, the input token ids
        labels: BxL, torch.float32
        """
